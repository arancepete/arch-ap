...
The scope of this project is only to do minimal installs. At some point, I will no longer modify or offer this script or the options for install of this script. As the official arch install script has become better this one is no longer needed. However, I still want a script that installs my two flavors of arch. 
...
```
bash <(curl -L link_to_script.com/arch.sh)
```
...
- The Old Original Script with all the customizations is located in the (all-in-one-2022 branch) here: <https://github.com/ChrisTitusTech/ArchTitus/tree/all-in-one-2022-script>
